...
const defaultRouteConfigs: Record<string, RouteConfig> = {
  ...
  "/daily-journal": { href: "/daily-journal", order: 8, visible: true },
  "/time-planner": { href: "/time-planner", order: 9, visible: true },
  "/people-crm": { href: "/people-crm", order: 10, visible: true },
  "/body-measurements": {
    href: "/body-measurements",
    order: 11,
    visible: true,
  },
  "/wealth": { href: "/wealth", order: 12, visible: true },
