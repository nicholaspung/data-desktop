...
func loadExperimentSampleData() error {
	...
	metrics := []map[string]interface{}{
		...
		{
			"name":          "Deep Work",
			"description":   "Time spent in focused, uninterrupted work",
			"type":          "time",
			"unit":          "minutes",
			"default_value": "0",
			"active":        true,
		...
		{
			"name":          "Reading",
			"description":   "Time spent reading books or articles",
			"type":          "time",
			"unit":          "minutes",
			"default_value": "0",
			"active":        true,
		...
		{
			"name":          "Exercise",
			"description":   "Time spent exercising or working out",
			"type":          "time",
			"unit":          "minutes",
			"default_value": "0",
			"active":        true,
...
func loadExperimentSampleDataWithDates(start, end time.Time) error {
	...
	metrics := []map[string]interface{}{
		...
		{
			"name":          "Focus Time",
			"description":   "Time spent in deep, focused work sessions",
			"type":          "time",
			"unit":          "minutes",
			"default_value": "0",
			"active":        true,
		...
		{
			"name":          "Study Time",
			"description":   "Time dedicated to learning and studying",
			"type":          "time",
			"unit":          "minutes",
			"default_value": "0",
			"active":        true,
		...
		{
			"name":          "Meditation",
			"description":   "Time spent in meditation or mindfulness practice",
			"type":          "time",
			"unit":          "minutes",
			"default_value": "0",
			"active":        true,
